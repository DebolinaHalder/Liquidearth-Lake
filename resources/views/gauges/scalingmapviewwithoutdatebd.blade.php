                ...
                <div class="col-lg-12">
                    ...
                    @if(!empty($gauges))
                        ...
                        <ul class="nav nav-pills">
                            ...
                            <li  class="active"><a href="{{route('gauges.scalingmapviewwdatebd')}}">Map View</a></li>
                            <li><a href="{{route('gauges.scalingtableviewwdatebd')}}">Table View</a></li>
