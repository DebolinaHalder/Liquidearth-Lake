    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
                ...
                <b><a href="{{route('gauges.scalingtableviewwdateil')}}">View Illinois Gauges List</a></b>
        <!-- Posts list -->
            @if(!empty($gauges))
                <div class="row">
                    ...
                    <ul class="nav nav-pills">
                        <li><a href="{{route('gauges.scalingmapviewwdatewa')}}">Map View</a></li>
                        <li class="active"><a href="{{route('gauges.scalingtableviewwdatewa')}}">Table View</a></li>
