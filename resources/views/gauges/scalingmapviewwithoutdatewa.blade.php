...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
                <b><a href="{{route('gauges.scalingmapviewwdate')}}">View North Carolina Gauges List</a></b>
        <!-- Posts list -->
            @if(!empty($gauges))
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left">
                            <h2>Washington Gauges List </h2>
                        </div>
                ...
                <ul class="nav nav-pills">
                    ...
                    <li  class="active"><a href="{{route('gauges.scalingmapviewwdatewa')}}">Map View</a></li>
                    <li><a href="{{route('gauges.scalingtableviewwdatewa')}}">Table View</a></li>
