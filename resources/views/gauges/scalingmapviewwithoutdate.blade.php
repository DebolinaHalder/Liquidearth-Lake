...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <b><a href="{{route('gauges.scalingmapviewwdatewa')}}">View Washington Gauges List</a></b>
        <!-- Posts list -->
            @if(!empty($gauges))
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left">
                            <h2>North Carolina Gauges List </h2>
                        </div>
                ...
                <ul class="nav nav-pills">
                    ...
                    <li  class="active"><a href="{{route('gauges.scalingmapviewwdate')}}">Map View</a></li>
                    <li><a href="{{route('gauges.scalingtableviewwdate')}}">Table View</a></li>
