        ...
        <!-- Posts list -->
            @if(!empty($gauges))
                ...
                <ul class="nav nav-pills">
                    ...
                    <li  class="active"><a href="{{route('gauges.scalingmapviewwdatefr')}}">Map View</a></li>
                    <li><a href="{{route('gauges.scalingtableviewwdatefr')}}">Table View</a></li>
