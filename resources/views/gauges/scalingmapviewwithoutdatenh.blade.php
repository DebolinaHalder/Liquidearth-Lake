        ...
        <div class="row vertical-center-row">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <b><a href="{{route('gauges.scalingmapviewwdateil')}}">View Illinois Gauges List</a></b><br/>
                    <b><a href="{{route('gauges.scalingmapviewwdatema')}}">View Massachusetts Gauges List</a></b>
                    <!-- Posts list -->
                    @if(!empty($gauges))
                        <div class="row">
                        ...
                        <ul class="nav nav-pills">
                            ...
                            <li  class="active"><a href="{{route('gauges.scalingmapviewwdatenh')}}">Map View</a></li>
                            <li><a href="{{route('gauges.scalingtableviewwdatenh')}}">Table View</a></li>
...
@section('script')
    <script>
        ...
        function initMap() {
            var options = {zoom:8,
                center:{lat:  43.008663, lng:-71.454391
                }
            };
