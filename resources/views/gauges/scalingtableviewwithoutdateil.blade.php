        ...
        <div class="col-lg-12">
            ...
            @endif
                <b><a href="{{route('gauges.scalingtableviewwdate')}}">View North Carolina Gauges List</a></b><br/>
                   <b><a href="{{route('gauges.scalingtableviewwdatewa')}}">View Washington Gauges List</a></b>
        <!-- Posts list -->
            @if(!empty($gauges))
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left">
                            <h2>Illinois Gauges List </h2>
                        </div>
                    ...
                    <ul class="nav nav-pills">
                        <li><a href="{{route('gauges.scalingmapviewwdateil')}}">Map View</a></li>
                        <li class="active"><a href="{{route('gauges.scalingtableviewwdateil')}}">Table View</a></li>
