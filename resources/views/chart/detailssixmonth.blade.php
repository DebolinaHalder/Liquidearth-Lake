...
@section('content')
        ...
        <div class="row">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="{{route('gauges.scaleddetailssixm',$gauge->id)}}">Last 6 Months</a></li>
                <li><a href="{{route('gauges.scaleddetailsthreem',$gauge->id)}}">Last 3 Months</a></li>
        ...
        <div style="padding:0px;color: #ff0000;border: 0px solid rgba(33, 37, 41, 0.1);" align="left">
            <h1>There is no reading for six month</h1>
        </div>
        @endif
        </div>
        </div>
