...
@section('content')
    ...
    <div class="container container-table">			<!-- Main div to hold all Data -->
        ...
        <div class="row vertical-center-row">
            ...
            <b><a href="{{route('readings.gaugeselectmapil')}}">Go TO Add Measurement (Illinois)</a></b>
            <h2 class="text-left">Select a Massachusetts gauge</h2>
            <ul class="nav nav-pills">
                <li class="active"><a href="{{route('readings.gaugeselectmapma')}}">Map View</a></li>
                <li><a href="{{route('readings.gaugeselectma')}}">Table View</a></li>
