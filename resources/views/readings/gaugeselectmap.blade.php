...
@section('content')
    ...
    <div class="container container-table">			<!-- Main div to hold all Data -->
        ...
        <div class="row vertical-center-row">
              <b><a href="{{route('readings.gaugeselectmapwa')}}">Go to Add Measurement (Washington)</a></b>
           <h2 class="text-left">Select a North Carolina gauge</h2>
            <ul class="nav nav-pills">
                <li class="active"><a href="{{route('readings.gaugeselectmap')}}">Map View</a></li>
                <li><a href="{{route('readings.gaugeselect')}}">Table View</a></li>
