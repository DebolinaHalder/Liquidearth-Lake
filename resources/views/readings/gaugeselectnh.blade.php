                    ...
                    @if(!empty($gauges))
                        <div class="row">
                            <div class="col-lg-12 margin-tb">
                                <div class="pull-left">
                                    <h2>Select a New Hampshire Gauge </h2>
                                </div>
                        ...
                        <ul class="nav nav-pills">
                            <li><a href="{{route('readings.gaugeselectmapnh')}}">Map View</a></li>
                            <li class="active"><a href="{{route('readings.gaugeselectnh')}}">Table View</a></li>
