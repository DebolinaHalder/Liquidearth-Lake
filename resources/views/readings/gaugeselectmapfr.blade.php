...
@section('content')
    ...
    <div class="container container-table">			<!-- Main div to hold all Data -->
        ...
        <div class="row vertical-center-row">
            ...
            <h2 class="text-left">Select a France gauge</h2>
            <ul class="nav nav-pills">
                <li class="active"><a href="{{route('readings.gaugeselectmapfr')}}">Map View</a></li>
                <li><a href="{{route('readings.gaugeselectfr')}}">Table View</a></li>
