...
@section('content')
    ...
    <div class="container container-table">			<!-- Main div to hold all Data -->
        ...
        <div class="row vertical-center-row">
            <b><a href="{{route('readings.gaugeselectmap')}}">Go TO Add Measurement (North Carolina)</a></b>
            <h2 class="text-left">Select a Washington gauge</h2>
            <ul class="nav nav-pills">
                <li class="active"><a href="{{route('readings.gaugeselectmapwa')}}">Map View</a></li>
                <li><a href="{{route('readings.gaugeselectwa')}}">Table View</a></li>
...
@section('script')
    ...
    <script>
        ...
        function initMap() {
                    var options = {zoom:8,
                center:{lat: 47.785743, lng:-122.049885
}
            };
