...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <b><a href="{{route('readings.gaugeselectil')}}">Go to Add Measurement (Illinois)</a></b>
        <!-- Posts list -->
            @if(!empty($gauges))
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left">
                            <h2>Select a Massachusetts Gauge </h2>
                        </div>
                    ...
                    <ul class="nav nav-pills">
                        <li><a href="{{route('readings.gaugeselectmapma')}}">Map View</a></li>
                        <li class="active"><a href="{{route('readings.gaugeselectma')}}">Table View</a></li>
